  ...
  <div>
    ...
    <div class="min-h-[500px] mt-8 p-4">
      ...
      <p class="z-50 relative text-xl font-BookkMyungjo">
        ...
        성전을 더럽힌 장사꾼들의 상을 뒤엎으셨습니다(마 21:13).
      </p>
      <br />
      <p class="text-zinc-700">
        마틴 루터, 찰스 스펄전, 마틴 루서 킹 주니어 등 역사 속 지도자들도 불의에
        맞서 강한 표현을 사용했습니다.<br /><br />
        전광훈 목사의 발언은 개인 비방이 아닌, 대한민국과 기독교를 위협하는
        세력에 대한 ‘거룩한 분노’의 표현입니다.<br /><br />
        중요한 것은 표현의 강도가 아니라, 그것이 무엇을 겨냥했는냐입니다.<br /><br />
        그의 발언은 특정 개인에 대한 비방이 아니라, 거짓과 불의를 향한 ‘거룩한
        분노’로 볼 수 있습니다.
      </p>
    </div>
  </div>
