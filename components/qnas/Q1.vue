  ...
  <div>
    ...
    <div class="min-h-[500px] mt-8 p-4">
      <p class="z-50 relative text-xl font-BookkMyungjo">
        오해: 정교분리 원칙에 따라 종교인은 정치에 개입하면 안된다
      </p>
      <br />
      <p class="z-50 relative text-xl font-BookkMyungjo">
        진실 : 많은 사람들이 정교분리 원칙을 잘못 이해하여 “교회는 정치에
        개입하면 안 된다”고 주장합니다.
      </p>
      <br />
      <p class="text-zinc-700">
        <span class="font-bold"
          >그러나 정교분리는 정부가 종교를 통제하지 못하도록 보호하는 원칙이지,
          종교가 정치에 발언하는 것을 금지하는 개념이 아닙니다.</span
        ><br /><br />
        기독교는 사회를 변화시키는 역할을 해야 합니다. 자유와 진리를 지키는 것은
        신앙의 연장선이며, 목회자로서 시대적 사명을 감당하는 것은 자연스러운
        일입니다.<br /><br />
        성경적 가치와 충돌하는 반기독교적 정책에 목소리를 내는 것은 신앙과
        양심의 자유에 기반한 정당한 권리입니다.
      </p>
    </div>
  </div>
</template>
