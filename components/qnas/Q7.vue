  ...
  <div>
    ...
    <div class="min-h-[500px] mt-8 p-4">
      ...
      <p class="text-zinc-700">
        6·25전쟁 당시 미국의 지원으로 대한민국이 자유를 지킬 수 있었으며, 반미
        정서가 확산될 때마다 한미동맹의 중요성을 강조하는 의미로
        사용되었습니다.<br /><br />

        특히 2002년 효순이·미선이 사건과 NLL 논란 등으로 동맹 약화 우려가
        커지면서, 자유민주주의와 국가 안보를 지키려는 보수·기독교 진영이
        성조기를 들기 시작했습니다.<br /><br />

        성조기는 대한민국의 생존과 안보를 위한 한미동맹의 상징이며, 반미·친북
        세력의 확산을 경계하고 자유민주주의를 지켜야 한다는 결집의 의미를 담고
        있습니다. 이는 미국을 맹목적으로 따르는 것이 아니라, 대한민국의 안전과
        번영을 위한 전략적 선택입니다.
      </p>
    </div>
  </div>
