  ...
  <div>
    ...
    <div class="min-h-[500px] mt-8 p-4">
      ...
      <p class="z-50 relative text-xl font-BookkMyungjo">
        ...
        단어만 부각해 가십화하는 것은 지양해 주시기 바랍니다.
      </p>
      <br />
      <p class="text-zinc-700">
        1) 빤쓰목사 오해 : 전광훈 목사가 성도들에게 속옷을 내리고 했다. 사실 :
        맹목적 신뢰의 위험성을 경고하는 예화였습니다. 특정 목사가 성도들에게
        책임을 전가한 사례를 비판하는 과정에서 나온 표현이며, 당시 설교를 들은
        목회자들도 “풍자적 표현”이라고 증언했으나, 언론이 일부만 발췌해 논란을
        키웠습니다.
        <br /><br />
        2) 하나님 까불면 죽어 오해 : 신성모독적인 발언이다. 사실 : 하나님과의
        친밀한 관계를 강조하는 표현이었습니다. 성경에서도 하나님이 인간과
        친구처럼 대화하는 장면이 있으며, 신성모독 의도가 없었음을 여러 차례
        해명했습니다.
        <br /><br />
        3) 생명책에서 뺀다 오해 : 특정 정치적 입장을 따르지 않으면 구원이
        취소된다. 사실 : 강조를 위한 비유적 표현이었습니다. 신학적 개념이 아니라
        신앙과 정치의 관계를 설명하는 과정에서 사용된 표현입니다.
      </p>
    </div>
  </div>
</template>
