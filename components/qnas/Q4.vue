    ...
    <div class="min-h-[500px] mt-8 p-4">
      ...
      <p class="z-50 relative text-xl font-BookkMyungjo">
        ...
        <span class="font-bold">
          사랑제일교회는 1954년부터 예배를 드려온 교회로, 투기와 무관합니다.
        </span>
      </p>
      <br />
      <p class="text-zinc-700">
        조합은 종교부지 지정 사실을 숨기고, 법적 절차를 무시한 강제 철거를
        시도했습니다. <br />그 과정에서 교인들이 부상을 입고, 교회 시설이
        심각하게 파손되었으며, 일부가 소실되는 사태가 벌어졌습니다.<br /><br />
        합의 이후에도 조합은
        <span class="font-bold">
          교회 부지를 줄이며 기만했으며, 언론과 협력해 왜곡된 여론전을 펼치고
          있습니다. </span
        ><br /><br />
        사랑제일교회는 종교의 자유와 재산권 보호를 위해 정당하게 대응하고
        있으며, 조합의 불법 행위와 여론 조작에 대해 끝까지 민·형사 책임을 물을
        것입니다.<br /><br />
        종교단체라는 이유로 당연히 요구할 수 있는 권리를 탐욕으로 왜곡하는
        행위는 다시는 대한민국에서 반복되어서는 안 됩니다.
      </p>
    </div>
  </div>
</template>
