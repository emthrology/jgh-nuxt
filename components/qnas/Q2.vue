    ...
    <div class="min-h-[500px] mt-8 p-4">
      ...
      <p class="z-50 relative text-xl font-BookkMyungjo">
        ...
        <span class="font-bold">
          그러나 광화문 집회에 참여하는 애국 시민들은 지난 20년 동안 단 한 번도
          폭력 집회를 한 적이 없습니다.
        </span>
      </p>
      <br />
      <p class="text-zinc-700">
        그럼에도 불구하고, 일부 언론과 정치 세력은 ‘극우’ 또는 ‘폭력적인
        시위대’로 몰아가며 부정적인 이미지를 덧씌우려 하고 있습니다.<br /><br />
        하지만 이것은 명백한 왜곡입니다.
        <br /><br />
        <span class="font-bold">
          광화문 집회는 헌법이 보장하는 정당한 애국 운동이며, ‘극우’ 프레임은
          정치적 선동에 불과합니다.
        </span>
      </p>
    </div>
